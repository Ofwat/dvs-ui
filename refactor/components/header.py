...
def build_auth_widget(identity: dict | None = None):
    ...
    display_name = identity.get("display_name") or identity.get("username") or "Signed in"
    username = identity.get("username") or display_name
    initials = (identity.get("initials") or "?").upper()
    return html.Div(
        className="app-auth-widget",
        style={
            "display": "flex",
...
def build_header(auth_widget=None):
    auth_widget = auth_widget or build_auth_widget()
    return html.Header(
        className="govuk-header",
        **{"data-module": "govuk-header"},
        children=html.Div(
            className="govuk-header__container app-width-container",
            style={
                "display": "flex",
                "alignItems": "center",
                            ...
                            children=[
                                svg.Svg(
                                    ...
                                    children=[
                                        ...
                                        svg.G(
                                            children=[
                                                svg.Circle(cx=20, cy=17.6, r="3.7"),
                                                svg.Circle(cx=10.2, cy=23.5, r="3.7"),
                                                svg.Circle(cx=3.7, cy=33.2, r="3.7"),
                                                svg.Circle(cx=31.7, cy=30.6, r="3.7"),
                                                svg.Circle(cx=43.3, cy=17.6, r="3.7"),
                                                svg.Circle(cx=53.2, cy=23.5, r="3.7"),
                                                svg.Circle(cx=59.7, cy=33.2, r="3.7"),
                                                svg.Path(
                                ...
                                html.Span("Ocean", className="govuk-header__product-name"),
                            ],
                        )
                    ]
                ),
                html.Div(id="auth-widget", children=auth_widget, style={"marginLeft": "auto"}),
            ],
        ),
    )
